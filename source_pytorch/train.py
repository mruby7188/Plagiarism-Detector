...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_features', type=int, default=2, metavar='IN',
                        help='input dimensions for neural net (default: 2)')
    parser.add_argument('--hidden_dim', type=int, default=20, metavar='IN',
                        help='input dimensions for neural net (default: 20)')
    parser.add_argument('--output_dim', type=int, default=1, metavar='OUT',
                        help='input dimensions for neural net (default: 1)')
